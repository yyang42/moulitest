...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/11/07 10:22:26 by juschaef          #+#    #+#             */
/*   Updated: 2014/12/11 11:07:47 by juschaef         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define BUFF_SIZE 65
# define MAX_PARALLEL_FILES 4096
# define MAX_BUFF_SIZE 30000000
...
void				ft_putnendl(char *c, size_t n);
void				ft_putnstr(char *c, size_t n);
...
void				ft_sort_array(char **s, int n);
