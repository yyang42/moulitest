...
static void unittest1(t_test *test)
{
	...
	mt_assert(strcmp(strnstr(buf, "deux", 10),  ft_strnstr(buf, "deux", 10)) == 0);
	...
	mt_assert(strcmp(ft_strnstr(buf, "9", 10), strnstr(buf, "9", 10)) == 0);
...
static void unittest2(t_test *test)
{
	...
	mt_assert(strcmp(strnstr(buf, "6", 10), ft_strnstr(buf, "6", 10)) == 0);
}
