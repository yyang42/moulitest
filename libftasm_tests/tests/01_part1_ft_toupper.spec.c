...
mt_test_toupper(num20, '0');
mt_test_toupper(num21, '0' - 1);
mt_test_toupper(num22, '9');
mt_test_toupper(num23, '9' + 1);
mt_test_toupper(num24, -1);

void	suite_01_part1_ft_toupper(t_suite *suite)
{
