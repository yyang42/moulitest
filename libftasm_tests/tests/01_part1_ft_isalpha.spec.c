...
mt_test_isalpha(num20, '0');
mt_test_isalpha(num21, '0' - 1);
mt_test_isalpha(num22, '9');
mt_test_isalpha(num23, '9' + 1);
mt_test_isalpha(num24, -1);

void	suite_01_part1_ft_isalpha(t_suite *suite)
{
